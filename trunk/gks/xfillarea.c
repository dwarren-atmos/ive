...
/*special for ive*/
	switch(fill_style){
	  case 0:
	    xXgksSetForeground(dpy, gc, XcPixelValue(ws, 10));
	    xXgksSetFillAreaClipRectangles(dpy, gc, ws, &(ws->xclip));
	    XFillPolygon(dpy, win, gc, ype, npnt, Complex, CoordModeOrigin);
	    return OK;
	    break;
	  case 1:
	    xXgksSetForeground(dpy, gc, XcPixelValue(ws, 11));
	    xXgksSetFillAreaClipRectangles(dpy, gc, ws, &(ws->xclip));
	    XFillPolygon(dpy, win, gc, ype, npnt, Complex, CoordModeOrigin);
	    return OK;
	    break;
	  case 2:
	    xXgksSetForeground(dpy, gc, XcPixelValue(ws, 12));
	    xXgksSetFillAreaClipRectangles(dpy, gc, ws, &(ws->xclip));
	    XFillPolygon(dpy, win, gc, ype, npnt, Complex, CoordModeOrigin);
	    return OK;
	    break;
	  case 3:
	    xXgksSetForeground(dpy, gc, XcPixelValue(ws, 13));
	    xXgksSetFillAreaClipRectangles(dpy, gc, ws, &(ws->xclip));
	    XFillPolygon(dpy, win, gc, ype, npnt, Complex, CoordModeOrigin);
	    return OK;
	    break;
	  case 4:
	    xXgksSetForeground(dpy, gc, XcPixelValue(ws, 9));
	    xXgksSetFillAreaClipRectangles(dpy, gc, ws, &(ws->xclip));
	    XFillPolygon(dpy, win, gc, ype, npnt, Complex, CoordModeOrigin);
	    return OK;
	    break;
	  case 5:
	    ...
	    XFillPolygon(dpy, win, gc, ype, npnt, Complex, CoordModeOrigin);
	    return OK;
	    xXgksSetForeground(dpy, gc, XcPixelValue(ws, 2));
	    break;
	  default: return OK;
	}
