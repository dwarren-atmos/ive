      subroutine setpla (error)
c-----------------------------------------------------------------------
c     $Id: setpla.f,v 1.6 1994/04/19 23:03:26 yuri Exp $
c     Purpose:
c        This subroutine sets the value of plat, which is used by the
...
c     History:
c      $Log: setpla.f,v $
c      Revision 1.6  1994/04/19 23:03:26  yuri
c      Big 1D flip commit.
c
c Revision 1.5  1994/02/16  17:00:46  yuri
c 	Just cleaning and getting rid of "interp_factors" stuff.
c
c Revision 1.4  1993/12/16  23:00:14  harry
c Set maplim correctly when turning off default map.
c
c Revision 1.3  1993/12/15  18:15:47  harry
...
c
c Revision 1.2  1993/08/05  17:59:31  warren
c Christoph's map stuff
c
c Revision 2.0  1992/07/01  21:14:42  millerp
...
c
         if ( error ) then
c
c           Log an error message and do not set the value of plat.
c
