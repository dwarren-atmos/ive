      subroutine setlw (error)
c-----------------------------------------------------------------------
c     $Id: setlw.f,v 1.1.1.1 1993/04/07 19:40:27 harry Exp $
c     Purpose:
...
c
c           Set line width scale factor to 1 (thinnest line).
c
            linwdth = 1.0
         elseif (curval(ibeg:ibeg) .eq. '2') then
c
c           Set line width scale factor to 2 (thicker line).
c
            linwdth = 2.0
         elseif (curval(ibeg:ibeg) .eq. '3') then
c
c           Set line width scale factor to 3 (thick line).
c
            linwdth = 3.0
         elseif (curval(ibeg:ibeg) .eq. '4') then
c
c           Set line width scale factor to 4 (thickest line).
c
            linwdth = 4.0
         else
c
